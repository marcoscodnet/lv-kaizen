        ...
        <div class="card-header">
            ...
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-box-open" aria-hidden="true"></i><span class="ms-2">Ubicaciones</span></h5>
                </div>
                <div class="col-8 col-sm-auto text-end ps-2">

                    <div id="table-customers-replace-element">
                        <a class="btn btn-falcon-default btn-sm d-inline-flex align-items-center" href="{{ route('ubicacions.create') }}">
                    ...
                    @foreach ($ubicacions as $ubicacion)
                        <tr>
                            ...
                            <td ><div>
                                    ...
                                    @can('ubicacion-editar')<a href="{{ route('ubicacions.edit',$ubicacion->id) }}" class="btn btn-link p-0" alt="Editar" title="Editar" data-bs-toggle="tooltip" data-bs-placement="top"><span class="text-500 fas fa-edit"></span></a>@endcan

                                    @can('ubicacion-eliminar')
                                        <form id="delete-form-{{ $ubicacion->id }}" method="post" action="{{ route('ubicacions.destroy',$ubicacion->id) }}" style="display: none">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                        </form>
                        ...
                        document.getElementById('delete-form-{{ $ubicacion->id }}').submit();
                        }
                        else{
                        event.preventDefault();
