...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor"><i class="fa fa-truck" aria-hidden="true"></i><span class="ms-2">Crear pedido</span></h5>
                </div>
        ...
        <div class="card-body bg-body-tertiary">
            <form role="form" action="{{ route('pedidos.store') }}" method="post" >
                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label for="nombre">
                                        ...
                                        <input type="checkbox" id="nueva_pieza_check" name="usar_nueva_pieza"
                                            ...
                                            {{ old('nueva_pieza') ? 'checked' : '' }}>
                                    </label>
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                           placeholder="Ingrese nueva pieza" value="{{ old('nombre') }}"
                                        {{ old('nombre') ? '' : 'disabled' }}>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="0.01" class="form-control formato-numero" id="minimo" name="minimo" placeholder="$ Mínimo"  value="{{ old('minimo') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="0.01" class="form-control formato-numero" id="senia" name="senia" placeholder="Seña"  value="{{ old('senia') }}">
                                </div>
                            </div>
                        </div>
