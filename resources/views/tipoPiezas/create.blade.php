...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor"><i class="fa fa-cogs" aria-hidden="true"></i><span class="ms-2">Crear tipo de artículo</span></h5>
                </div>
        ...
        <div class="card-body bg-body-tertiary">
            <form role="form" action="{{ route('tipoPiezas.store') }}" method="post" >
                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="maneja_stock" name="maneja_stock"
                                               value="1" {{ old('maneja_stock', 1) ? 'checked' : '' }}>
