        ...
        <div class="card-header">
            ...
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fa fa-motorcycle" aria-hidden="true"></i><span class="ms-2">Unidades</span></h5>
                </div>
                <div class="col-8 col-sm-auto text-end ps-2">

                    <div id="table-customers-replace-element">
                        <a class="btn btn-falcon-default btn-sm d-inline-flex align-items-center" href="{{ route('unidads.create') }}">
                    ...
                    // Actions column
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            @can('unidad-ver')
                                ...
                                actionsHtml += '<a href="{{ route("unidads.show", ":id") }}" class="btn btn-link p-0" alt="Ver" title="Ver" data-bs-toggle="tooltip" data-bs-placement="top"><span class="text-500 fas fa-search"></span></a>'.replace(':id', row.id);
                            @endcan
                            ...
                            @can('unidad-eliminar')
                                actionsHtml += '<form id="delete-form-' + row.id + '" method="post" action="{{ route('unidads.destroy', '') }}/' + row.id + '" style="display: none">';
