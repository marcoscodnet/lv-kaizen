        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                @can('usuario-listar')<li class="nav-item">
                    ...
                    <!-- parent pages-->
                    @can('usuario-listar')<a class="nav-link {{ request()->routeIs('users.*') ? 'active' : '' }}" href="{{ route('users.index') }}" role="button">
                    ...
                    @can('rol-listar')<a class="nav-link {{ request()->routeIs('roles.*') ? 'active' : '' }}" href="{{ route('roles.index') }}" role="button">
                ...
                <li class="nav-item">
                    ...
                    @can('color-listar')
                        <a class="nav-link {{ request()->routeIs('colors.*') ? 'active' : '' }}" href="{{ route('colors.index') }}" role="button">
                    ...
                    @endcan
                    @can('concepto-listar')
                        <a class="nav-link {{ request()->routeIs('conceptos.*') ? 'active' : '' }}" href="{{ route('conceptos.index') }}" role="button">
                    ...
                    @can('documento-listar')
                        <a class="nav-link {{ request()->routeIs('documentos.*') ? 'active' : '' }}" href="{{ route('documentos.index') }}" role="button">
                    ...
                    @endcan
                    @can('marca-listar')
                        <a class="nav-link {{ request()->routeIs('marcas.*') ? 'active' : '' }}" href="{{ route('marcas.index') }}" role="button">
                    ...
                    @can('modelo-listar')
                        <a class="nav-link {{ request()->routeIs('modelos.*') ? 'active' : '' }}" href="{{ route('modelos.index') }}" role="button">
                    ...
                    @endcan
                    @can('modelo-listar')
                        <a class="nav-link {{ request()->routeIs('parametros.*') ? 'active' : '' }}" href="{{ route('parametros.edit','1') }}" role="button">
                    ...
                    @can('sucursal-listar')
                        <a class="nav-link {{ request()->routeIs('sucursals.*') ? 'active' : '' }}" href="{{ route('sucursals.index') }}" role="button">
                    ...
                    @can('ubicacion-listar')
                        <a class="nav-link {{ request()->routeIs('ubicacions.*') ? 'active' : '' }}" href="{{ route('ubicacions.index') }}" role="button">
                    ...
                    @can('tipo-servicio-listar')
                        <a class="nav-link {{ request()->routeIs('tipoServicios.*') ? 'active' : '' }}" href="{{ route('tipoServicios.index') }}" role="button">
                    ...
                    @can('tipo-unidad-listar')
                        <a class="nav-link {{ request()->routeIs('tipounidads.*') ? 'active' : '' }}" href="{{ route('tipoUnidads.index') }}" role="button">
                    ...
                    <li class="nav-item">
                        ...
                        @can('cliente-listar')
                            <a class="nav-link {{ request()->routeIs('clientes.*') ? 'active' : '' }}" href="{{ route('clientes.index') }}" role="button">
                        ...
                        @endcan
                        @can('producto-listar')
                            <a class="nav-link {{ request()->routeIs('productos.*') ? 'active' : '' }}" href="{{ route('productos.index') }}" role="button">
                        ...
                        @can('proveedor-listar')
                            <a class="nav-link {{ request()->routeIs('proveedors*') ? 'active' : '' }}" href="{{ route('proveedors.index') }}" role="button">
                        ...
                        @endcan
                        @can('unidad-listar')
                            <a class="nav-link {{ request()->routeIs('unidads.*') ? 'active' : '' }}" href="{{ route('unidads.index') }}" role="button">
                    ...
                    <li class="nav-item">
                        ...
                        @can('caja-listar')
                            <a class="nav-link {{ request()->routeIs('cajas.index') || request()->routeIs('cajas.show') ? 'active' : '' }}" href="{{ route('cajas.index') }}" role="button">
                                <div class="d-flex align-items-center">
                        ...
                        @can('caja-arqueo')
                            @if($cajaAbierta)
                                <a class="nav-link {{ request()->routeIs('cajas.arqueo*') ? 'active' : '' }}" href="{{ route('cajas.arqueo.actual') }}" role="button">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        @can('unidad-movimiento-listar')
                            <a class="nav-link {{ request()->routeIs('movimientos.*') ? 'active' : '' }}" href="{{ route('movimientos.index') }}" role="button">
                        ...
                        @can('pedido-listar')
                            <a class="nav-link {{ request()->routeIs('pedidos.*') ? 'active' : '' }}" href="{{ route('pedidos.index') }}" role="button">
                        ...
                        @can('servicio-listar')
                            <a class="nav-link {{ request()->routeIs('servicios.*') ? 'active' : '' }}" href="{{ route('servicios.index') }}" role="button">
                        ...
                        @can('venta-listar')
                            <a class="nav-link {{ request()->routeIs('ventas.*') ? 'active' : '' }}" href="{{ route('ventas.index') }}" role="button">
