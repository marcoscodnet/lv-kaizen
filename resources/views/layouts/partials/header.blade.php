<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="{{ route('home') }}">
        <div class="d-flex align-items-center"><img class="me-2" src="{{ asset('images/logo_kaisen.png') }}" alt="" width="200" /><span class="font-sans-serif text-primary"></span>
        </div>
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-xl">
                    ...
                    @if(Auth::user()->image)
                        ...
                        <img class="rounded-circle" src="{{ url('/images/'.Auth::user()->image) }}" alt="" />
                    @else

                        <img class="rounded-circle" src="{{ url('/images/user.png') }}" alt="" />
                    @endif
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('users.perfil',array('idUser'=>Auth::user()->id)) }}">Perfil</a>
