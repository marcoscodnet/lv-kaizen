        ...
        <div class="card-header">
            ...
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fa fa-motorcycle" aria-hidden="true"></i><span class="ms-2">Unidades vendidas</span></h5>
                </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#example1').DataTable({
                ...
                paging : true,
                "ajax": {
                    "url": "{{ route('unidadsvendidas.dataTable') }}",
                    "type": "POST",
                    "data": function (d) {
