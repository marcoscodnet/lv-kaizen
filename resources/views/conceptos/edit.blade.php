        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor"><i class="fa fa-cash-register" aria-hidden="true"></i><span class="ms-2">Editar Concepto</span></h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="@if (old('nombre')){{ old('nombre') }}@else{{ $concepto->nombre }}@endif">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-check mt-4">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="ticket" name="ticket" value="1"
                                        {{ old('ticket', $concepto->ticket ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-check mt-4">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="referencia" name="referencia" value="1"
                                        {{ old('referencia', $concepto->referencia ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-check mt-4">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="credito" name="credito" value="1"
                                        {{ old('credito', $concepto->credito ?? true) ? 'checked' : '' }}>
