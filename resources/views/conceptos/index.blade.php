        ...
        <div class="card-header">
            ...
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fa fa-cash-register" aria-hidden="true"></i><span class="ms-2">Conceptos</span></h5>
                </div>
                <div class="col-8 col-sm-auto text-end ps-2">

                    <div id="table-customers-replace-element">
                        <a class="btn btn-falcon-default btn-sm d-inline-flex align-items-center" href="{{ route('conceptos.create') }}">
            ...
            <div class="tab-content table-responsive">
                <table id="example1" class="table table-bordered table-striped table-hover fs-10 mb-0">
                    ...
                    @foreach ($conceptos as $concepto)
                            ...
                            <td class="text-end"><div>
                                    ...
                                    @can('concepto-ver')
                                        <a class="btn btn-link p-0"
                                           href="{{ route('conceptos.show', $concepto->id) }}"
                                           alt="Ver"
                                           title="Ver"
                                    ...
                                    @can('concepto-editar')<a class="btn btn-link p-0" href="{{ route('conceptos.edit',$concepto->id) }}" alt="Editar" title="Editar" data-bs-toggle="tooltip" data-bs-placement="top"><span class="text-500 fas fa-edit"></span></a>@endcan

                                @can('concepto-eliminar')
                                    <form id="delete-form-{{ $concepto->id }}" method="post" action="{{ route('conceptos.destroy',$concepto->id) }}" style="display: none">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                    </form>
                        ...
                        document.getElementById('delete-form-{{ $concepto->id }}').submit();
                        }
                        else{
                        event.preventDefault();
