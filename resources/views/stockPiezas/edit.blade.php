                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="0.01" class="form-control formato-numero" id="costo" name="costo" placeholder="Costo" value="@if (old('costo')){{ old('costo') }}@else{{ $stockPieza->costo }}@endif">
                                </div>
                            </div>
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
                                    <label for="precio_minimo">$ mínimo</label>
                                    <input type="text" step="0.01" class="form-control formato-numero" id="precio_minimo" name="precio_minimo" placeholder="$ mínimo" value="@if (old('precio_minimo')){{ old('precio_minimo') }}@else{{ $stockPieza->precio_minimo }}@endif">
                                </div>
                            </div>
