        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="ms-2">Crear venta de artículos</span></h5>
                </div>
                ...
                <div class="tab-content">
                    <div class="box-body">
                        ...
                        <div class="row" id="divTaller" style="display: none">
                            <div class="col-12 col-lg-4">
                                <div class="form-group">
                                    <label for="servicio_id">Orden de servicio</label>
                                    <select name="servicio_id" id="servicio_id" class="form-control select-simple">
                                        <option value="">Seleccionar...</option>
                                        @foreach($serviciosAbiertos as $s)
                                            <option value="{{ $s->id }}" {{ old('servicio_id') == $s->id ? 'selected' : '' }}>
                                                #{{ $s->id }} — {{ $s->modelo }} | Motor: {{ $s->motor }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            <tr>
                ...
                <td style="width: 10%;"><input type="text" name="precio[]" class="form-control formato-numero precio input-monto" required></td>
                <td><a href="#" class="btn btn-danger btn-sm removeRow"><i class="fa fa-times text-white"></i></a></td>
            </tr>
        `;
            ...
            $('form').on('submit', function (e) {
                ...
                if (destino === 'Salón') {
                    if (!$('#cliente_id').val()) {
                        e.preventDefault();
                        $('#cliente_id').next('.select2').find('.select2-selection').css('border-color', 'red');
...
// Recalculate notice on any relevant change
            ...
            $(document).ready(actualizarTotalPiezas);
