                        ...
                        <div class="form-group col-md-12">
                            ...
                            <table class="table">
                                ...
                                @foreach($oldPiezas as $i => $piezaId)
                                    <tr>
                                        <td>
                                            <select name="pieza_id[]" class="form-control" required>
                                        ...
                                        <td>
                                            <select name="sucursal_id[]" class="form-control" required>
                                                ...
                                                @foreach($sucursals as $sucursalId => $sucursal)
                                                    <option value="{{ $sucursalId }}" {{ old('sucursal_id.' . $i) == $sucursalId ? 'selected' : '' }}>
                                                        {{ $sucursal }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-danger removeRowPieza"><i class="fa fa-minus"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="row" id="divSucursal" style="display: none">
                            ...
                            <div class="col-lg-offset-3 col-lg-3 col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pedido" name="pedido" placeholder="Nro. Pedido Reparación" value="{{ old('pedido') }}">
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            <tr>
                ...
                <td style="width: 20%;">
                    <select name="sucursal_id[]" class="form-control sucursalSelect">
                        <option value="">Seleccionar...</option>
                    </select>
                </td>
