                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="0.01" class="form-control formato-numero" id="precio" name="precio" placeholder="$ sugerido" value="@if (old('precio')){{ old('precio') }}@else{{ $producto->precio }}@endif">
                                </div>
                            </div>
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
