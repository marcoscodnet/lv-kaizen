...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor"><i class="fa fa-cubes" aria-hidden="true"></i><span class="ms-2">Crear modelo</span></h5>
                </div>
        ...
        <div class="card-body bg-body-tertiary">
            <form role="form" action="{{ route('modelos.store') }}" method="post" >
                {{ csrf_field() }}
