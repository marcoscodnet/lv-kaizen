            ...
            <form action="{{ route('movimiento_cajas.update', $mov->id) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select name="entidad_id" id="entidad_id" class="form-control select2" required>
                            <option value="">Seleccione</option>
                            @foreach($entidads as $entidad)
                                <option value="{{ $entidad->id }}"
                                    {{ $mov->entidad_id == $entidad->id ? 'selected' : '' }}>
                                    {{ $entidad->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-12 col-md-2">
                        ...
                        <input type="text" name="monto" id="monto" class="form-control formato-numero"
