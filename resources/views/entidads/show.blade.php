        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor"><i class="fa fa-university" aria-hidden="true"></i><span class="ms-2">Ver forma de pago</span></h5>
                </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="form-check mt-4">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="cuenta" name="cuenta" value="1"
                                           {{ old('cuenta', $entidad->cuenta ?? true) ? 'checked' : '' }} disabled>
